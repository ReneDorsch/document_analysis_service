...
from app.core.apis import ContextAnalyzer
from app.core.apis.util_functions import save_as_json
...
class Task:
    ...
    def execute_annotation(task_settings: TaskSettings) -> None:
        ...
        # Make Backup of Data
        path = os.path.join(OUTPUT_DIR, f"{task_settings.document_id}_analyze_results.json")
